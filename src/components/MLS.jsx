...
function MLS() {
  ...
  useEffect(() => {
    fetch(`${import.meta.env.BASE_URL}Data/Matches.json`, setLiveMatches);
fetch(`${import.meta.env.BASE_URL}Data/Allclubs.json`, setUpcomingMatches);
fetch(`${import.meta.env.BASE_URL}Data/hroic.json`, setHroic);
fetch(`${import.meta.env.BASE_URL}Data/stories.json`, setTopPlayers);
fetch(`${import.meta.env.BASE_URL}Data/matchmoments.json`, setHighlights);
fetch(`${import.meta.env.BASE_URL}Data/pastmatches.json`, setTeams);
fetch(`${import.meta.env.BASE_URL}Data/bigc.json`, setBigc);
fetch(`${import.meta.env.BASE_URL}Data/sfatl.json`, setFavorites);
fetch(`${import.meta.env.BASE_URL}Data/Mlsstudio.json`, setMlsis);
  }, []);
